...
local ThemeManager = {} do
	...
	function ThemeManager:ThemeUpdate()
		...
		self.Library.AccentColorDark2 = self.Library:GetDarkerColor(self.Library.AccentColor2);
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddLabel('Accent color2'):AddColorPicker('AccentColor2', { Default = self.Library.AccentColor2 });
		groupbox:AddLabel('Accent color3'):AddColorPicker('AccentColor3', { Default = self.Library.AccentColor3 });
