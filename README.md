...
local Library = {
    ...
    AccentColor3 = Color3.fromRGB(255, 255, 255);
...
Library.AccentColorDark2 = Library:GetDarkerColor(Library.AccentColor2);
...
do
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        local Fill = Library:Create('Frame', {
            ...
            BorderColor3 = Library.AccentColorDark2;
        ...
        function Slider:UpdateColors()
            Fill.BackgroundColor3 = Library.AccentColor2;
            Fill.BorderColor3 = Library.AccentColorDark2;
        end;
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        local Highlight = Library:Create('Frame', {
            BackgroundColor3 = Library.AccentColor3;
            BorderSizePixel = 0;
            Size = UDim2.new(1, 0, 0, 2);
            ZIndex = 5;
            Visible = false;
        ...
        function Tab:ShowTab()
            ...
            Highlight.BackgroundColor3 = Library.AccentColor3;
